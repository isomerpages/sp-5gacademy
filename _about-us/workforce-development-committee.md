...
|Mr Benjamin Moey     | Siemens Pte Ltd | Manufacturer; Software/Service provider |Siemens’ Digital Enterprise portfolio provides companies of all sizes with consistent solutions and services for integrating and digitalizing the entire value chain. As an innovation leader, we showcase the next level of cutting-edge technologies – such as artificial intelligence, cloud and edge computing, industrial 5G, and additive manufacturing. Siemens also launched its “Advance Manufacturing Transformation Center (AMTC)’, the first of its kind digital transformation competence center that provides guidance, support and training to manufacturing facilities in ASEAN. |
